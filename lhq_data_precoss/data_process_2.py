...
# fine_rets = []
# coarse_rets = []
# print('split words for fine 5000 data...')
# with open(fine_val_file, 'r') as f:
#     for line in tqdm(f):
#         item = json.loads(line)
#         segment, _ = ltp.seg([item['title']])
#         item['title_split'] = segment[0]
...
# print(len(fine_rets))
# print(len(coarse_rets))
# with open(fine_val_save_file, 'w') as f:
#     f.writelines(fine_rets)
# with open(coarse_val_save_file, 'w') as f:
#     f.writelines(coarse_rets)
...
# # 测试集分词
# print('split words for testing A data:')
# print('split words for test 4000 data...')
# rets = []
...
# # 测试集分词
# print('split words for testing B data:')
# print('split words for test 10000 data...')
# rets = []
