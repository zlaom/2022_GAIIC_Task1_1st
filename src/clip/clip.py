...
tokenizer = transformers.AutoTokenizer.from_pretrained("M-CLIP/M-BERT-Base-69", cache_dir='~/.cache')
def tokenize(txt):
    txt_tok = tokenizer(txt, return_tensors='pt', padding='max_length', truncation=True, max_length=77)
    return txt_tok
