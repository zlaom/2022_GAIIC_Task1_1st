...
attr_dict_file = 'data/tmp_data/equal_processed_data/attr_to_attrvals.json'
word_dict_file = 'data/tmp_data/vocab/word_dict.json'
vocab_dict_save_file = 'data/tmp_data/vocab/vocab_dict.json'
vocab_txt_save_file = 'data/tmp_data/vocab/vocab.txt'

data_dir = 'data/tmp_data/split_word'
save_dir = 'data/tmp_data/equal_split_word'
if not os.path.exists(save_dir):
    os.makedirs(save_dir)
    
name_list = ['fine45000.txt', 'coarse89588.txt', 'fine5000.txt', 'coarse10412.txt', 'test10000.txt', 'test4000.txt']
