...
test_equal_process_data = os.path.join(save_dir, 'test_equal_processed_data.txt')
test_split_word = os.path.join(save_dir, 'test_split_word.txt')
test_equal_split_word = os.path.join(save_dir, 'test_equal_split_word.txt')
...
print(len(rets))
with open(test_equal_process_data, 'w') as f:
    f.writelines(rets)
...
rets = []
with open(test_equal_process_data, 'r') as f:
    for line in tqdm(f):
...
# 保存数据
print(len(rets))
with open(test_split_word, 'w') as f:
    f.writelines(rets)
...
rets = []
with open(test_split_word, 'r') as f:
...
with open(test_equal_split_word, 'w') as f:
    f.writelines(rets)